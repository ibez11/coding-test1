                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="{{route('register')}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input name="gender" value="1" checked type="radio" />Laki-laki
                                <input name="gender" value="0"  type="radio" />Perempuan
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="birthdate" type="date" class="form-control" name="birthdate" value="" required autofocus>
